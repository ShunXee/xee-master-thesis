\documentclass[UTF8,AutoFakeBold]{template/szu-master}
...
% 重新调整参考文献项目之间的行距
\usepackage{template/bib-spacing}
...
\titleformat{\subsubsection}{\zihao{4}\bfseries\fontspec{fonts/songti-bold.otf}}{\thesubsubsection}{1em}{}


% 定义目录标题样式
\titlecontents{section}[0em]{\bfseries\fontspec{fonts/songti-bold.otf}\zihao{-4}}{\contentspush{\thecontentslabel\hspace{1em}}}{}{\titlerule*[0.4pc]{.}\contentspage\vspace{1.6pt}}%
...
\titlecontents{subsection}[1em]{\fontspec{fonts/simsun.ttc}\zihao{-4}}{{\thecontentslabel}\hspace{1em}}{}{\titlerule*[0.4pc]{.}\contentspage\vspace{1.6pt}}

\titlecontents{subsubsection}[1.8em]{\fontspec{fonts/simsun.ttc}\zihao{-4}}{\thecontentslabel\hspace{1em}}{}{\titlerule*[0.4pc]{.}\contentspage\vspace{1.6pt}}
...
%封面 自行配置生成pdf文件导入即可
\includepdf[pages={1,2}]{chapters/master-page.pdf}
...
%缩略语
\input{chapters/sign-and-abc.tex}
...
\input{chapters/cp-1.tex}
\input{chapters/cp-2.tex}
\input{chapters/cp-3.tex}
\input{chapters/cp-4.tex}
\input{chapters/cp-5.tex}
...
\begin{spacing}{1.8}
	\bibliographystyle{template/gbt7714-2005} 
	\bibliography{bib/ref-paper}
\end{spacing}
...
\fancyfoot[C]{\songti\zihao{5}{\thepage}}
\input{chapters/my-papers.tex}

% 添加学术评语目录条目
%\addtocontents{toc}{\protect\vspace{1.6pt}}
%\addtocontents{toc}{\noindent\protect\fontspec{fonts/songti-bold.otf}\protect\zihao{-4}\protect\normalfont 附：指导教师对研究生学位论文的学术评语\par}
% 添加答辩决议书目录条目
%\addtocontents{toc}{\protect\vspace{1.6pt}}
%\addtocontents{toc}{\noindent\protect\fontspec{fonts/songti-bold.otf}\protect\zihao{-4}\protect\normalfont ~~~~~~~~答辩委员会决议书\par}
% 添加学术评语页面
%\clearpage
%\includepdf[pages={1}]{chapters/comment.pdf}
% 添加答辩决议书页面
%\clearpage
%\includepdf[pages={1,2}]{chapters/decision.pdf}

%当需要在论文末尾插入相关的文件，可以生成pdf文件格式进行附加，附加一页就是1，多页就是1，2，3
%\includepdf[pages={1}]{chapters/comment.pdf}
%\includepdf[pages={1}]{chapters/decision.pdf}
