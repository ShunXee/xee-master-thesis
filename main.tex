...
\renewcommand{\titleCN}[1][~]{基于XXX研究}
\renewcommand{\titleEN}[1][~]{The Research Base on XXXX}
...
\captionsetup[table]{labelsep=space, labelfont=bf, textfont=bf, font={wuhao}, justification=centering, singlelinecheck=false, skip=6pt}
%%%%%%%% 图每节重新标号
\makeatletter %
\@addtoreset{figure}{section}
\makeatother  %
\renewcommand{\thefigure}{\thesection-\arabic{figure}}
\captionsetup[figure]{labelsep=space, labelfont=bf, textfont=bf, font={wuhao}, justification=centering, singlelinecheck=false, skip=6pt}
